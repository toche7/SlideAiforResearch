...
2. **AI Writing Workflow** — ร่างเนื้อหา
...
ร่างเนื้อหาก่อน แล้วค่อยจัดรูปแบบด้วย LaTeX

---

## ปัญหาที่นักวิจัยไทยเจอบ่อย

- ไม่รู้จะเริ่มเขียนจากตรงไหน — **Writer's Block**
- คิดเป็นภาษาไทย แต่ต้องเขียนเป็นภาษาอังกฤษ
- เขียนทีละประโยค ช้ามาก ไม่ไหลลื่น
- พอเจอ LaTeX ก็ติดอีกชั้นหนึ่ง

> **แนวทางแก้ไข:** แยกการ **คิด** ออกจากการ **จัดรูปแบบ**
> ให้ AI ช่วยขั้นกลาง — แล้วค่อยนำเข้า LaTeX

---

## Workflow: ร่าง → AI เรียบเรียง → มนุษย์ขัดเกลา → จัด Format

```
1. คิด / ร่าง (ภาษาไทยก็ได้)
        ↓
2. AI เรียบเรียง / แปลเป็น Academic English
        ↓
3. มนุษย์ตรวจสอบ ขัดเกลา และใส่มุมมองของตัวเอง  ← สำคัญที่สุด
        ↓
4. นำเข้า LaTeX → Overleaf → Submit
```

> AI เรียบเรียงรูปประโยค — แต่การ **ขัดเกลาขั้นสุดท้ายเป็นหน้าที่ของมนุษย์**

---

## เทคนิค 1: ร่างภาษาไทย → แปลอังกฤษ

**ขั้นตอน:**
1. เขียนความคิดเป็นภาษาไทยก่อน — ลื่นไหล ไม่ติดขัด
2. ให้ AI แปลและปรับเป็น academic English
3. ตรวจสอบ nuance และ technical terms

**Prompt ตัวอย่าง:**
```
แปลข้อความนี้เป็น academic English สำหรับ research paper
และปรับให้เหมาะกับ journal style:
"[ข้อความภาษาไทย]"
```

> ⚠️ คำเฉพาะทาง เช่น "machine learning", "p-value" — ใช้อังกฤษตั้งแต่แรก

---

## เทคนิค 2: Outline / Mind Map → ให้ AI เรียบเรียง

**วิธีการ:**
- โยนความคิดออกมาเป็น bullet หรือ mind map
- ไม่ต้องสนใจลำดับหรือความสมบูรณ์
- ให้ AI จัดกลุ่ม เรียบเรียง และเพิ่มเติมส่วนที่ขาด

**Prompt ตัวอย่าง:**
```
ฉันมีหัวข้อเหล่านี้สำหรับบท Introduction:
- AI ใช้ใน healthcare เพิ่มขึ้น
- ข้อมูลผู้ป่วยมีมากแต่วิเคราะห์ไม่ทัน
- deep learning ช่วยได้
- ยังไม่มีงานวิจัยในบริบทไทย

ช่วยเรียบเรียงเป็น academic paragraph ภาษาอังกฤษ
```

---

## ทำไม Workflow นี้ถึงได้ผล

| ปัญหา | วิธีแก้ |
|---|---|
| Writer's Block | Brain dump ก่อน ไม่ต้องสมบูรณ์ |
| คิดเป็นไทย เขียนเป็นอังกฤษ | ร่างไทย → AI แปล |
| เนื้อหาไม่เป็นของตัวเอง | คุณคิด AI แค่จัดรูปแบบ |
| ช้าเพราะทำทุกอย่างพร้อมกัน | แยกขั้นตอน คิด / เรียบเรียง / format |

> **สรุป:** ใช้ AI เป็นเครื่องมือ ไม่ใช่ให้ AI คิดแทน

---

## ปัญหาที่พบบ่อยเมื่อใช้ AI ช่วยเขียน

| # | ปัญหา | อาการ |
|---|---|---|
| 1 | **ไม่ต่อเนื่องระหว่าง section** | แต่ละส่วนดีแต่อ่านรวมกันแล้วสะดุด |
| 2 | **Hallucination** | อ้างอิงข้อมูล / งานวิจัยที่ไม่มีจริง |
| 3 | **Generic เกินไป** | เนื้อหากว้าง ไม่ specific กับงานของเรา |
| 4 | **ไม่ใช่ voice ของเรา** | อ่านแล้วรู้ว่าไม่ใช่สไตล์ผู้เขียน |
| 5 | **Overconfident tone** | เขียนมั่นใจเกินจริง ทั้งที่ยังไม่แน่ชัด |

---

## หลักการจำง่าย

> AI เขียนได้ดี **"ระดับประโยค"**
> แต่ยังอ่อนแอ **"ระดับภาพรวม"**

**มนุษย์ต้องรับผิดชอบ:**
- ตรวจ logic และ flow ทั้งบท — อ่านออกเสียงจะรู้ทันทีว่าตรงไหนสะดุด
- ตรวจสอบ reference ทุกตัวด้วยตัวเอง
- ขัดเกลาให้เป็น voice ของตัวเอง
