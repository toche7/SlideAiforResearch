...
![bg contain](fig/AIpolicy.jpg)

---

![bg contain](fig/ML.png)
...
**อธิบายง่าย ๆ**
สมมติว่าเรามีข้อมูล X และ Y

<div class = columns>
<div>

**วิธีเดิม — สมการกำหนดตายตัว (Deterministic)**

$$X \xrightarrow{F(X)} Y$$

> เขียนกฎเองทุกข้อ แล้วให้คอมพิวเตอร์คำนวณตาม
</div>
<div>

**Machine Learning — เรียนรู้กฎจากข้อมูล**

$$X, Y \xrightarrow{\text{learning}} F(X)$$

> ให้ข้อมูล X และ Y แล้วให้คอมพิวเตอร์ **หากฎเอง**

---
## ทำไมนักวิจัยต้องรู้จัก Machine Learning?

<div class="columns">
<div>

**ข้อมูลในงานวิจัยมีความซับซ้อนมากขึ้น**
- ข้อมูลผู้ป่วยหลักล้านรายการ
- ตัวแปรหลายร้อยตัวในชุดข้อมูลเดียว
- ข้อมูลข้อความ รูปภาพ และสัญญาณที่วิเคราะห์ด้วยสถิติเดิมไม่ได้

**ML ตอบโจทย์ที่สถิติดั้งเดิมทำไม่ได้**
- ค้นหา pattern ที่ไม่เป็นเส้นตรง
- จัดการตัวแปรจำนวนมากพร้อมกัน
- ทำนายผลลัพธ์ล่วงหน้าได้

</div>
<div>

**งานวิจัยที่ใช้ ML กำลังเติบโตเร็วมาก**

| สาขา | ตัวอย่างการใช้ ML |
|---|---|
| การแพทย์ | ทำนายความเสี่ยงโรค |
| พยาบาลศาสตร์ | วิเคราะห์ภาระงานและ burnout |
| สาธารณสุข | คาดการณ์การระบาด |
| สังคมศาสตร์ | วิเคราะห์ความคิดเห็น |

> **ข้อสรุป:** ML ไม่ใช่แค่เครื่องมือของ data scientist — คือทักษะที่นักวิจัยยุคใหม่ต้องมี
...
เพื่อพัฒนาโมเดลจำแนกผู้ป่วยที่มีความเสี่ยงสูงต่อการกลับมารักษาซ้ำภายใน 30 วันโดยใช้ข้อมูล EHR  (Electronic Health Record, เวชระเบียนอิเล็กทรอนิกส์)
